...
def test_full_local_environment(pg_connection, pg_policy_id, bookings_table):
    ...
    # Query DynamoDB
    dynamo_response = bookings_table.get_item(Key={"employeeId": employee_id, "bookingId": booking_id})
    ...
    bookings_table.delete_item(Key={"employeeId": employee_id, "bookingId": booking_id})

    cleanup_response = bookings_table.get_item(Key={"employeeId": employee_id, "bookingId": booking_id})
