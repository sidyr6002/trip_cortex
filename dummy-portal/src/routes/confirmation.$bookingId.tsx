    ...
    if (navState?.flight) {
      ...
      if (stored) {
        try {
          ...
          if (!parsed?.flight) throw new Error('Invalid booking data');
    ...
    return (
      <div className="min-h-screen bg-linear-to-b from-primary-100 via-primary-50 to-white">
        ...
        <div className="container mx-auto px-4 py-12 text-center">
          ...
          <h1 className="text-2xl font-bold text-content mb-4">{loadError ? 'Booking Data Corrupted' : 'Booking Not Found'}</h1>
          <p className="text-content-muted mb-6">{loadError ? 'The booking data could not be read. It may be corrupted or incomplete.' : "We couldn't find this booking."}</p>
          <button
