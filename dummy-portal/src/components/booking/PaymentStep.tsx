...
export default function PaymentStep({ totalAmount, onConfirm, onBack }: PaymentStepProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-divider-light/60 relative overflow-hidden">
      ...
      <div>
        ...
        {termsError && (
          <p className="text-monza-500 text-xs mt-1.5 font-medium px-2">You must accept the terms</p>
        )}
      </div>
